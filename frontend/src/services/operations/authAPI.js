  ...
  return async (dispatch) => {
    ...
    try {
      ...
      if (response.data.user.accountType === "Admin") {
        ...
        navigate("/dashboard/admin"); // Redirect Admins here
      } else if (response.data.user.accountType === "Instructor") {
        console.log("Redirecting to Instructor Dashboard");
        navigate("/dashboard/my-courses"); // Adjust if your instructor path is different
      } else {
        console.log("Redirecting to Student Dashboard");
        navigate("/dashboard/my-profile"); // Default redirect for Students
      }
